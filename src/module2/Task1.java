...
public class Task1 {
    ...
    //Same for int[] array
    static int getMaxPositive(int[] anArray) {
    ...
    //Same for int[] array
    static int getMultiplication(int[] anArray) {
    ...
    //Same for int[] array
    static int getModulus(int[] anArray) {
    ...
    static double getSecondLargest(double[] anArray) {
        ...
        for (double element : anArray) {
            if (element > max) {
                ...
                max = element;
            } else if ((element < max) && (secondLargest == max)) {
